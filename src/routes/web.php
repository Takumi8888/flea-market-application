...
use App\Http\Controllers\Item\ExhibitionController;
use App\Http\Controllers\Item\ItemController;
use App\Http\Controllers\Item\PurchaseController;
...
Route::group(['middleware' => 'auth'], function () {
    // ログアウト処理
    Route::POST('/logout', [UserSessionController::class, 'logout'])->name('userSession.logout');

    // プロフィール画面
    Route::get('/mypage', [ItemController::class, 'mypage'])->name('item.mypage');
    Route::get('/mypage/sell/{item}', [ExhibitionController::class, 'edit'])->name('exhibition.edit');
    Route::put('/mypage/sell/{item}', [ExhibitionController::class, 'update'])->name('exhibition.update');
    ...
    // 商品詳細画面
    Route::post('/item/{item}/like', [ItemController::class, 'toggleLike'])->name('item.toggleLike');
    ...
    Route::put('/purchase/address/{item}', [AddressController::class, 'update'])->name('address.update');

    // stripe決済画面
    Route::get('/purchase/{item}/stripe', [PurchaseController::class, 'stripeCreate'])->name('purchase.stripeCreate');
    Route::post('/purchase/{item}/stripe', [PurchaseController::class, 'stripeStore'])->name('purchase.stripeStore');
...
//////////////////////////////////////////////////////////
// 以下参照先：src\vendor\laravel\fortify\routes\routes.php
