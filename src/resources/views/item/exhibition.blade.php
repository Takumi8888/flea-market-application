...
@section('css')
    <link rel="stylesheet" href="{{ asset('css/item/exhibition.css') }}">
@endsection
...
@section('content')
    <div class="container">
        ...
        <form class="exhibition-form" action="/sell" method="POST" enctype="multipart/form-data">
            ...
            {{-- ボタン --}}
            <button class="exhibition-form__button--exhibition" type="submit">出品する</button>
        </form>
    </div>

<script src="{{ asset('js/item/exhibition.js') }}"></script>
<script>
